...
bl_info = {
    ...
    "version": (0, 4, 0),
    "blender": (2, 80, 0),
    "location": "Toolbar > Misc Tab > Bool Tool",
...
class OBJECT_OT_BTool_DrawPolyBrush(Operator):
...
# Fast Transform
class OBJECT_OT_BTool_FastTransform(Operator):
...
class OBJECT_OT_BTool_Union(Operator):
...
class OBJECT_OT_BTool_Inters(Operator):
...
class OBJECT_OT_BTool_Diff(Operator):
...
class OBJECT_OT_BTool_Slice(Operator):
...
class OBJECT_OT_BTool_FindBrush(Operator):
...
class OBJECT_OT_BTool_MoveStack(Operator):
...
class OBJECT_OT_BTool_EnableBrush(Operator):
...
class OBJECT_OT_BTool_EnableThisBrush(Operator):
...
# Enable or Disable a Brush Directly
class OBJECT_OT_BTool_EnableFTransform(Operator):
...
class OBJECT_OT_BTool_Remove(Operator):
...
# Apply All to Canvas
class OBJECT_OT_BTool_AllBrushToMesh(Operator):
...
# Apply This Brush to the Canvas
class OBJECT_OT_BTool_BrushToMesh(Operator):
...
classes = (
    ...
    OBJECT_OT_BTool_Union,
    OBJECT_OT_BTool_Diff,
    OBJECT_OT_BTool_Inters,
    OBJECT_OT_BTool_Slice,
    OBJECT_OT_BTool_DrawPolyBrush,
    OBJECT_OT_BTool_Remove,
    OBJECT_OT_BTool_AllBrushToMesh,
    OBJECT_OT_BTool_BrushToMesh,
    OBJECT_OT_BTool_FindBrush,
    OBJECT_OT_BTool_MoveStack,
    OBJECT_OT_BTool_EnableBrush,
    OBJECT_OT_BTool_EnableThisBrush,
    OBJECT_OT_BTool_EnableFTransform,
    OBJECT_OT_BTool_FastTransform,
